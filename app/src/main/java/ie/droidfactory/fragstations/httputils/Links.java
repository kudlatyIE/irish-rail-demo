...
public enum Links {
	...
	GET_CURRENT_TRAIN ("getCurrentTrainsXML"),
	...
	GET_STATION_DATA_BY_STATION_NAME_TIME_RANGE ("getStationDataByNameXML?StationDesc=Bayside&NumMins="),//minutes = 5-90
	GET_STATION_DATA_BY_STATION_CODE ("getStationDataByCodeXML?StationCode="),
	GET_STATION_DATA_BY_STATION_CODE_TIME_RANGE ("getStationDataByCodeXML_WithNumMins?StationCode=mhide&NumMins=");
